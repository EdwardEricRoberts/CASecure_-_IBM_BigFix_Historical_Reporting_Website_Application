...
<script>
	...
	if(!patchTuesdayOn) {
		var historicDataFetchURL = "http://localhost/CASecure_MSP_ver_1.0/database/fetch/FetchHistoricPatchComplianceReportData2.php?cid=" + currentUserID + "&site=" + site + "&cg=" + computerGroup;
	}
	else {
		var historicDataFetchURL = "http://localhost/CASecure_MSP_ver_1.0/database/fetch/FetchHistoricPatchTuesdayComplianceReportData.php?cid=" + currentUserID + "&site=" + site + "&cg=" + computerGroup;
	}
...
<div id="patchTuesdayCheckDiv">
  <div>
    
    <input type="checkbox"  id="patchTuesdayCheckDiv" style="cursor:pointer;" onclick="changeReportType()">
	<label for="patchTuesdayCheck">Exclude Out of Date Systems</label>
  </div>
(Only Applies to Site "Patches for Windows")
</div>
      ...
      <script id="rendered-js" >
var checkboxValues = JSON.parse(localStorage.getItem('checkboxValues')) || {},
$checkboxes = $("#patchTuesdayCheckDiv :checkbox");
...
<!-- Current computer group dynamic label end -->
	<!--	<div id="patchTuesdayCheckDiv" style="cursor:pointer;" onclick="changeReportType()">
			<input id="patchTuesdayCheck" name="pt" type="checkbox" onmouseover="" style="cursor:pointer;" onload="loadCheckBoxStatus()">
			<b>  Exclude Out of Date Systems <br>(Only Applies to Site "Patches for Windows")</b>
			</input>
			-->
