...
<html>
   <head>
      ...
      <title>CASecure > Reporting > 12 Month Cumulative Compliance</title>
	  ...
	  <div class="span-24">
         <div style="background-color:#cacaca; width:100%; margin-top:2px; height:23px; line-height:23px;">      
            <span style="text-align:center;">
               ...
               <span style="z-index:0; position:absolute;"><a href="Reporting.php" class="breadcrumblink">Reporting</a> &nbsp;&raquo;&nbsp; 12 Month Cumulative Compliance</span>
            </span>
         </div>
      </div>
<!-- end breadcrumbs -->      	
      ...
      <div class="span-24 last">
	     <div class="span-24">
	        <div class="pagetitle2">&nbsp;&nbsp;12 Month Cumulative Compliance</div>
	     </div>
      </div> 
...
$(function() {
  $('input[name="datetimes"]').daterangepicker({
	...
	<input type="text" name="datetimes" style="width:200px; margin-left:15px;"/>
      <br>
<!-- start page content -->
<!--
      <div class="container">
