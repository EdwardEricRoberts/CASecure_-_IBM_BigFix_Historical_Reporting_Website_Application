	  ...
	  <div class="span-24">
         <div style="background-color:#cacaca; width:100%; margin-top:2px; height:23px; line-height:23px;"> 
            <span style="text-align:center;">
               ...
               <span style="z-index:0; position:absolute;"><a href="Reporting.php" class="breadcrumblink">Reporting</a> &nbsp;&raquo;&nbsp; Inventory Report by Last Report Time</span>
            </span>
         </div>
      </div>
<!-- end breadcrumbs -->
...
<script>
	...
	var inventoryByFirstReportTimeProxy = "proxies/InventoryReport.php?user=" + curUser + "&pass=" + password + "&serv=" + server + "&cg=" + computerGroup;
	
	httpEncode(inventoryByFirstReportTimeProxy);
	xmlTableParser(inventoryByFirstReportTimeProxy, "#inventoryByLastReportTimeTable");
		...
		request.onreadystatechange = function() {
			if ((this.readyState === 4) && (this.status === 200)) {
				...
				$(document).ready( function () {
				        ...
				        $('#inventoryByLastReportTimeTable').dataTable({
                           dom: 'Blfrtip',
...
<!-- end datatable -->
				...
				//var appCountTable = document.getElementById('inventoryByLastReportTimeTable');
	...
	compGroup.onreadystatechange = function() {
		if ((this.readyState === 4) && (this.status === 200)) {
			...
			for (var i = 0; i < rowCount; i++) {
				rowHTML = "<li><a href='InventoryReportByLastReportTime.php?cg=" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "'>" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "</a></li>";
...
<table id="inventoryByLastReportTimeTable">
			      <thead>
				     <tr>
