	...
	try{
		...
		try {
			...
			$db->beginTransaction();
				...
				$param2XML->addChild('Name', 'Computer Group');
				$param2XML->addChild('URL', 'cg');
				$param2XML->addChild('Value', $computerGroup);
				$param2XML->addChild('Description', 'The User selected Computer Group.');
