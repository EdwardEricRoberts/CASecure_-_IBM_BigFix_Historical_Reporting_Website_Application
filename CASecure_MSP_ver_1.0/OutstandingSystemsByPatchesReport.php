...
<html>
   <head>
      ...
      <title>Outstanding Systems by Patches Report</title>
...
<!-- end breadcrumbs -->
 <br>
      <div class="span-24 last">
	     <div class="pagetitle2" style="margin-bottom:20px; margin-left:10px; float:left">Outstanding Systems by Patches Report<br>
		 </div>	  
	  </div>
...
<script>
	...
	// AJAX call for the Outstanding Systems by Patches Report
	var sourceSeverityProxy = "proxies/OutstandingSystemsByPatchesReport.php?user=" + curUser + "&pass=" + password + "&serv=" + server + "&cg=" + computerGroup;
			   ...
			   <table id="sourceSeverityTable" style="border:1px solid lightgrey; table-layout:fixed; ">
			      <thead>
				     <tr>
						...
						<th width="150">Outstanding Systems</th>
