...
<html>
   <head>
      ...
      <title>Microsoft Patch Compliance Executive Summary</title>
...
<!-- start chart top left of page "Total Systems Vulnerability" -->
		 <!--<div class="span-15 append-1" >    
	       <!-- <div id="severeVulnerabilityChart" style="height:100px; white-space:nowrap; overflow:hidden; width:400px; margin-bottom:20px; "> -->
	           <!--<div>
		          <br><img id="wLoad" src="includes/loading.gif">
	           </div>-->
...
<!-- button dropdown start -->
			...
			<div class="dropdown-check-list" style="float: left; position: relative; width:912px;">
				<span class="anchor">Select Computer Groups</span>
				<ul id="cgItems" class="items" style="columns:4;">
...
<table style="width:919px; margin-top:10px; border-weight:1px; border:1px solid black;">
<tr>
<td>
	        <div style="margin-left:260px;">
		       
			      
			         <span style="font-family: Arial, Helvetica, sans-serif; font-size:15pt; margin-right:10px; margin-top:-7px; margin-bottom:7px;">Compliance:</span>
				     <span style="font-family: Arial, Helvetica, sans-serif; font-size:15pt; font-weight:bolder; margin-right:20px;" id="complianceValue">0</span>
				     <span style="font-family: Arial, Helvetica, sans-serif; font-size:15pt;" id="computerCount">Computer Groups</span>
...
<div class="span-24 last">
	<hr style="width:919px; margin-left:0px;"/>
