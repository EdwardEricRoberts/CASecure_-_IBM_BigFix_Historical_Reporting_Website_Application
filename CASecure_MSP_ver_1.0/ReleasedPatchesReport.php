...
<html>
   <head>
      ...
      <title>Releaesed Patches Report</title>
...
<!-- end breadcrumbs -->
      ...
      <div class="span-24 last">
	     <div class="pagetitle2" style="margin-bottom:20px; margin-left:10px; float:left">Released Patches Report<br>
		 </div>	  
	  </div>
<script>
	...
	var unspecifiedContentProxy = "proxies/PatchReleaseList.php?user=" + curUser + "&pass=" + password + "&serv=" + server + "&cg=" + computerGroup;
	...
	compGroup.onreadystatechange = function() {
		if ((this.readyState === 4) && (this.status === 200)) {
			...
			for (var i = 0; i < rowCount; i++) {
				rowHTML = "<li><a href='ReleasedPatchesReport.php?cg=" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "'>" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "</a></li>";
