<?php
	...
	$relevance = 
		...
		'( '.
			...
			'((preceding text of last " " of operating system of item 0 of it) as string & " <br>" & (following text of last " " of operating system of item 0 of it) as string) | "<none>", '.
		...
		if ($filter == "All Machines") {
			$relevance .= 
				...
				'bes sites '.
				'whose (name of it = "Patches for RHEL6 Native Tools") ';
		}
		else {
			$relevance .=
				'items 0 of '.
				'( '.
					'subscribed computers of bes sites whose (name of it = "Patches for RHEL6 Native Tools"), '.
					'it'.
				') '.
