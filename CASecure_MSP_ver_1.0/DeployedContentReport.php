...
<html>
   <head>
      ...
      <title>Deployed Content Report</title>
	  ...
	  <div class="span-24">
         <div style="background-color:#cacaca; width:100%; margin-top:2px; height:23px; line-height:23px;"> 
            <span style="text-align:center;">
               ...
               <span style="z-index:0; position:absolute;"><a href="Reporting.php" class="breadcrumblink">Reporting</a> &nbsp;&raquo;&nbsp; Deployed Content Report</span>
            </span>
         </div>
      </div>
<!-- end breadcrumbs -->
      ...
      <div class="span-24 last">
	     <div class="pagetitle2" style="margin-bottom:20px; margin-left:10px; float:left">Deployed Content Report<br>
		 </div>	  
	  </div>
<script>
	...
	var deployedContentProxy = "proxies/DeployedContentReport.php?user=" + curUser + "&pass=" + password + "&serv=" + server + "&cg=" + computerGroup;
	xmlTableParser(deployedContentProxy, "#deployedContentTable");
			...
			if ((this.readyState === 4) && (this.status === 200)) {
				...
				$.fn.dataTable.moment( 'ddd, MMM DD, YYYY' );
				     $(document).ready( function () {
				        $('#deployedContentTable').dataTable({
                           dom: 'Blfrtip',
	...
	compGroup.onreadystatechange = function() {
		if ((this.readyState === 4) && (this.status === 200)) {
			...
			for (var i = 0; i < rowCount; i++) {
				rowHTML = "<li><a href='DeployedContentReport.php?cg=" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "'>" + xmlDoc.getElementsByTagName("Answer")[i].childNodes[0].nodeValue + "</a></li>";
...
<!-- start chart top left of page  -->
		<div class="span-15 append-1">
			<div id="severeVulnerabilityChart" style="height:80px; white-space:nowrap; overflow:hidden; width:400px; margin-bottom:20px; "> 
				<div id="wLoad">
				...
				<div>
					<div>
						...
						<span style="padding-left:20px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; white-space: nowrap;"  id="patchCount">Patches</span>
					</div>
			   </div>
			</div>
		</div>
