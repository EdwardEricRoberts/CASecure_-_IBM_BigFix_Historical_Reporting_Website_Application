		...
		<div class="span-24">
			<div style="background-color:#cacaca; width:100%; margin-top:2px; height:23px; line-height:23px;"> 
				<span style="text-align:center;">
					...
					<span style="z-index:0; position:absolute;"><a href="Administration.php" class="breadcrumblink">Administration</a> &nbsp;&raquo;&nbsp; Delete User</span>
				</span>
			</div>
		</div>
<!-- end breadcrumbs -->
		...
		<div class="span-24 last">
			<div class="pagetitle2" style="margin-bottom:20px; margin-left:10px; float:left">Delete User<br>
			</div>	  
		</div>
		...
		<form action="#" method="post">
			...
			<div class="span-24 last">
				...
				<input id="submit" type="submit" value="Delete User" onclick="deleteUser()">
			</div>
