	 ...
	 var compGroup = new XMLHttpRequest();
		 ...
		 if ((this.readyState === 4) && (this.status === 200)) {
			...
			for (var i = 0; i < tupleCount; i++) {
				...
				rowHTML = "<option><input type='checkbox' class='groupSelection' name='bes_computer_groups' id='" + groupID + "' value='" + groupID + "' " + ((computerGroups.indexOf(parseInt(groupID)) > -1) ? "checked" : "") + "/><label>&nbsp;" + groupName + "</label></option>";
...
<script src="includes/jquery.selectMe.js"></script>
<link rel="stylesheet" type="text/css" href="includes/jquery.selectMe.css ">
	...
	<form action="#" method="get">
		...
		<p>
			<select id="first" name="first" multiple>
				...
				<option value="2">CAS Servers</option>
				<option value="3">CAS Laptops</option>
				<option value="4">CAS Desktops</option>
				<option value="5">CAS DMZ</option>
				<option value="6">Patchable Servers</option>
				<option value="7">VM Machines</option>
				<option value="8">Relays</option>
				<option value="9">SPIRIT Production</option>
				<option value="10">CAS Workstations</option>
				<option value="10">CAS Systems</option>
				<option value="11">CAS-MS-Patches-Critical</option>
				<option value="12">CAS-MS-Patches-Moderate</option>
				<option value="13">CAS-MS-Patches-Important</option>
				<option value="14">CAS-MS-Patches-Low</option>
				<option value="15">CAS-MS-Patches-Exchange</option>
				<option value="16">CAS-MS-Patches-Office</option>
				<option value="17">CAS-MS-Patches-.Net</option>
				<option value="18">CAS-MS-Patches-SQL</option>
				<option value="19">CAS-MS-Patches-SharePoint</option>
				<option value="20">CAS-MS-Patches-App</option>
				<option value="21">CAS-MS-Patches-Java</option>-->
			</select>
		</p>
